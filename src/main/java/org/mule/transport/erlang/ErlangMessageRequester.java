...
public class ErlangMessageRequester extends AbstractMessageRequester {
    // TODO implement & integration test requester

    public ErlangMessageRequester(final InboundEndpoint endpoint) {
        super(endpoint);
    }
    ...
    protected MuleMessage doRequest(final long timeout) throws Exception {
        /*
         * IMPLEMENTATION NOTE: This method should make a request to the underlying transport.
         */
    ...
    public void doDisconnect() throws Exception {
         ...
         * return the MessageRequester into a disconnected state so that it can be connected again using the doConnect() method.
         */
    }
    ...
    public void doDispose() {
        /*
         * IMPLEMENTATION NOTE: Is called when the Requester is being dispoed and should clean up any resources. The doStop()
         * and doDisconnect() methods will be called implicitly when this method is called.
         */
    }
