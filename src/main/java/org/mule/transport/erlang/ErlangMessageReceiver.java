...
public class ErlangMessageReceiver extends AbstractPollingMessageReceiver {
    ...
    public void doStart() {
         ...
         * polling thread, for the Axis Message receiver the start method on the
         * SOAPService is called. What action is performed here depends on the
         * transport being used. Most of the time a custom provider doesn't need
