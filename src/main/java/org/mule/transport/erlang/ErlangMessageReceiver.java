...
/**
 * The <code>ErlangMessageReceiver</code> creates a single worker listening to an
 * OtpMbox (which can only be consumed by a single thread) but delegates the routing
 * of incoming messages to workers.
 */
public class ErlangMessageReceiver extends AbstractMessageReceiver
{
    ...
    private static void throwAsRuntimeException(Exception e)
    {
