...
public class ErlangNamespaceHandlerTestCase extends FunctionalTestCase {
    ...
    private void testConnectorConfiguration(final String connectorName, final String nodeName, final String cookie, final Integer port)
            throws Exception {
    ...
    public void testEndpointsInService() throws Exception {
        ...
        final EndpointURI inboundEndpointURI = ((ServiceCompositeMessageSource) testService.getMessageSource()).getEndpoint("erlin")
                .getEndpointURI();
        ...
        final OutboundPassThroughRouter optr = (OutboundPassThroughRouter) ((DefaultOutboundRouterCollection) testService
