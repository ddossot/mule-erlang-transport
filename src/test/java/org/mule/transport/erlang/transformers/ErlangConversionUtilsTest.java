...
public class ErlangConversionUtilsTest
{
    ...
    {
        final Object[] values = new Object[]{"string", 'a', Byte.MAX_VALUE, Short.MAX_VALUE,
            Integer.MAX_VALUE, Long.MAX_VALUE, BigInteger.valueOf(Long.MAX_VALUE).multiply(BigInteger.TEN),
            Float.MAX_VALUE, Double.MAX_VALUE, Boolean.TRUE, Arrays.asList(new Object[]{1, "a", Math.PI})};
    ...
    public void byteArrayRoundTrip()
    {
        ...
        assertEquals(
            "hello",
            new String(
                (byte[]) ErlangConversionUtils.erlangToJava(ErlangConversionUtils.javaToErlang(source))));
    }
    ...
    public void erlangToJavaOnly()
    {
        ...
        assertEquals("pid", new OtpErlangPid("test", 1, 2, 3),
            ErlangConversionUtils.erlangToJava(new OtpErlangPid("test", 1, 2, 3)));
    }
