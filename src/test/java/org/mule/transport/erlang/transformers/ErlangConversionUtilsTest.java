...
public class ErlangConversionUtilsTest
{
    ...
    public void roundTrips()
    {
        ...
        {
            "string", 'a', Byte.MAX_VALUE, Short.MAX_VALUE, Integer.MAX_VALUE, Long.MAX_VALUE,
            BigInteger.valueOf(Long.MAX_VALUE).multiply(BigInteger.TEN), Float.MAX_VALUE, Double.MAX_VALUE,
            Boolean.TRUE, Arrays.asList(new Object[]
            {
                1, "a", Math.PI
            })
        };
